<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:113:"D:\phpstudy_pro\WWW\tp5-rbac-api\tp5-rbac-api/application/assessment\view\personnelstatus\trial_confirmation.html";i:1624956238;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="<?php echo url('savePersonnelStatus'); ?>" method="post" data-type="ajax">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="dates" lay-verify="required" id="date1" lay-reqtext="试用日期是必填项，岂能为空？" placeholder="试用日期" autocomplete="off" class="layui-input" style="width: 270px;">
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label"><?php echo $type; ?>备注：</label>
        <div class="layui-input-inline">
