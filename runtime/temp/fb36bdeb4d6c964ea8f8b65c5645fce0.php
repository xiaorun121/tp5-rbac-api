<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"D:\phpstudy_pro\WWW\tp5-rbac-api\tp5-rbac-api/application/assessment\view\report\sexreport.html";i:1624867854;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <tbody>
                                    <tr data-index="0" class="">
                                        <td data-field="username" data-key="3-0-0" class="">
                                            <div class="layui-table-cell laytable-cell-3-0-0">性别</div>
                                        </td>
                                    ...
                                    <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                                        <tr data-index="<?php echo $k; ?>" class="">
                                            <td data-field="username" data-key="3-0-0" class="">
                                                <div class="layui-table-cell laytable-cell-3-0-0"><?php echo $v['sex']; ?></div>
                                            </td>
                                            <td data-field="joinTime" data-key="3-0-1" class="">
