<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:115:"D:\phpstudy_pro\WWW\tp5-rbac-api\tp5-rbac-api/application/assessment\view\personnelstatus\dismissal_employment.html";i:1625478685;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="<?php echo url('savePersonnelStatus'); ?>" method="post" data-type="ajax">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">被<?php echo $type; ?>人：</label>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label"><?php echo $type; if($type == '返聘'): ?>开始<?php endif; ?>日期：</label>
        <div class="layui-input-inline">
            <input type="text" name="to_date1" lay-verify="required" id="date1" lay-reqtext="试用日期是必填项，岂能为空？" placeholder="开始日期" autocomplete="off" class="layui-input" style="width: 270px;">
        </div>
    </div>

    <?php if($type == '返聘'): ?>
        <div class="layui-form-item">
            <label class="layui-form-label"><?php echo $type; ?>结束日期：</label>
            <div class="layui-input-inline">
                <input type="text" name="to_date2" lay-verify="required" id="date2" lay-reqtext="试用日期是必填项，岂能为空？" placeholder="结束日期" autocomplete="off" class="layui-input" style="width: 270px;">
            </div>
        </div>
    <?php endif; ?>
