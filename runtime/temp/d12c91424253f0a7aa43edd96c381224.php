<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"D:\phpstudy_pro\WWW\tp5-rbac-api\tp5-rbac-api/application/assessment\view\personal\saveenpty.html";i:1619491855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <form class="layui-form" action="" lay-filter="component-form-group" method="post" data-type="ajax">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="driver_age" id="driver_age" value="" readonly style="color: gray;background-color: #ededef !important;" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="now_age" id="now_age" placeholder="" value="" readonly style="color: gray;background-color: #ededef !important;" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
$(function(){
    var birth = $('#repty_date').val(); //得到日期生成的值，如：2017-08-18
    if(birth != ''){
        var d = new Date();
        var myDate = d.getFullYear() + '-' + (((d.getMonth()+1) >= 10) ? (d.getMonth()+1) : '0' + (d.getMonth()+1)) + '-' + d.getDate();
        birth = birth.split("-");
        myDate = myDate.split("-");
        var months = Math.abs((parseInt(birth[0]) * 12 + parseInt(birth[1])) - (parseInt(myDate[0]) * 12 + parseInt(myDate[1])));
        $('#driver_age').val(months);
        $('#now_age').val(months);
    }
})
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  laydate.render({
    elem: '#repty_date'
    ,done: function(value){
        var birth = value; //得到日期生成的值，如：2017-08-18
        var d = new Date();
        var myDate = d.getFullYear() + '-' + (((d.getMonth()+1) >= 10) ? (d.getMonth()+1) : '0' + (d.getMonth()+1)) + '-' + d.getDate();
        birth = birth.split("-");
        myDate = myDate.split("-");
